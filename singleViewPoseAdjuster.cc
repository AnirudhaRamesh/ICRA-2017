...
int main(int argc, char** argv){
	...
	for(int i = 0; i < numObs; ++i){
		...
		problem.AddResidualBlock(pnpError, new ceres::HuberLoss(0.001), rotAngleAxis, trans);
	}
	...
	problem.AddResidualBlock(translationRegularizer, new ceres::HuberLoss(0.8), trans);
