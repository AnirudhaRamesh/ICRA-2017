function write_inputfile_pos(keypoints, car_points, car_centre, H, W, L, K, ry, lambda, eig_vec, kp_lookup)
    ...
    %Create file
    file_to_be_created = "ceres_input_singleViewPoseAdjuster.txt" ; 
